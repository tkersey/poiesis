...
export function buildLineage(value) {
  ...
  return Object.freeze({
    ...
    parent: { release: "v1.0.1", candidate_commit: value.parentCandidateCommit, application_id: value.parentApplicationId, wasm_sha256: value.parentWasmSha256, birth_genesis_frame_id: value.birthGenesisFrameId, birth_terminal_frame_id: value.birthTerminalFrameId, birth_receipt_sha256: value.birthReceiptSha256 },

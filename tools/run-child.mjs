...
function publicApproval(value) {
  return Object.freeze({ request_id: value.requestId, proposal_digest: value.proposalDigest, path: value.path, expected_sha256: value.expectedSha256, replacement_sha256: value.replacementSha256, policy_digest: value.policyDigest });
}

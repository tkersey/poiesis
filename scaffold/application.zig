...
const definition = @import("generated_definition");
...
pub const Application = world.application(.{
    ...
    .external = .{
        world.external(Compiled.Machine, Compiled.DecisionSite.site_id, .{
            ...
            .maximum_attempts = 1,
            .maximum_result_bytes = @as(u32, @intCast(definition.Definition.decision.maximum_result_bytes)),
        }),
        ...
        world.external(Compiled.Machine, Compiled.ActionSites[3].site_id, .{
            ...
            .interface = "repo.release-search.v1",
            .authority = world.Authority.file_read,
            .maximum_attempts = 3,
...
test "application preserves the Poiesis v1 ABI and resource tuple" {

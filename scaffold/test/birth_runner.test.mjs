...
describe("controlled birth runner", () => {
  test("projects only bounded parent evidence into the Poiesis birth receipt", () => {
    ...
    expect(receipt).toMatchObject({ poiesis_format: 1, mode: "birth", parent_release: "v1.0.2", changed_paths: _birthInternals.expectedChangedPaths, full_check_passed: true, hidden_birth_verifier_passed: true });
